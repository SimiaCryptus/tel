    ...
    (function () {
      ...
      function initReadingProgress() {
        ...
        const onScroll = throttle(() => {
          ...
          const progress = Math.min(
            ...
            Math.max(
              0,
              ((scrolled - articleTop + windowHeight * 0.5) / articleHeight) * 100
            )
          );
      ...
      function initComparisonTable() {
        ...
        rows.forEach(row => {
          row.addEventListener('mouseenter', () => row.classList.add('comparison-table-row--highlighted'));
          row.addEventListener('mouseleave', () => row.classList.remove('comparison-table-row--highlighted'));
        });
